(function() {
    ...
    var WhoToFollow = (function () {
      ...
      */
       ...
       */
      var parseProfilePage = function parseProfilePage(username, htmlString) {
        ...
        if (settings.seenOffsetSwitched && lastSeenTimestamp && lastSeenTimestamp > Date.now() / 1000 - settings.seenOffset * (24 * 3600)) {
          isHighlighting = false;
        }
      ...
      return {
         ...
         */
        getData: function getData(username, callback) {
